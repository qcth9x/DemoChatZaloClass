...
class ConversationViewController: UIViewController, UITableViewDataSource, UITableViewDelegate{
    ...
    func initData(){
        ...
        let message2OfConversation1 = Message(id: 2, content: "Toi nay hoc 20h30 nhe", senderID: 1, conversationID: 1, time: "20h20", status: "Thanh cong")
        ...
        let conversation2 = Conversation(id: 2, name: "Nhóm gia đình - Private", members: [],messages: messagesOfConversation2, managers: [])
        
        let conversation3 = Conversation(id: 3, name: "Công ty VietDevelopers", members: [],messages: [], managers: [])
